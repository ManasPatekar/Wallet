...
function _createActorMethod(actor, methodName, func, blsVerify) {
    ...
    if (func.annotations.includes('query') || func.annotations.includes('composite_query')) {
        ...
        caller = async (options, ...args) => {
            ...
            const { certificate, reply } = await (0,_polling__WEBPACK_IMPORTED_MODULE_4__.pollForResponse)(agent, ecid, requestId, pollStrategy, blsVerify);
            reply;
...
/***/ "./src/declarations/wallet/index.js":
/*!******************************************!*\
  !*** ./src/declarations/wallet/index.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   idlFactory: () => (/* reexport safe */ _wallet_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
...
/* harmony import */ var _wallet_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./wallet.did.js */ "./src/declarations/wallet/wallet.did.js");
 ...
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_wallet_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
 ...
 */
 const wallet = createActor(canisterId);


/***/ }),

/***/ "./src/declarations/wallet/wallet.did.js":
/*!***********************************************!*\
  !*** ./src/declarations/wallet/wallet.did.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!****************************************!*\
  !*** ./src/wallet_assets/src/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_wallet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/wallet */ "./src/declarations/wallet/index.js");


window.addEventListener("load", async function() {
  try {
    const currentAmount = await _declarations_wallet__WEBPACK_IMPORTED_MODULE_0__.wallet.checkBalance();
...
document.querySelector("form").addEventListener("submit", async function(event) {
  ...
  try {
    if (!isNaN(inputAmount) && inputAmount > 0) {
      await _declarations_wallet__WEBPACK_IMPORTED_MODULE_0__.wallet.topUp(inputAmount);
    }

    if (!isNaN(outputAmount) && outputAmount > 0) {
      await _declarations_wallet__WEBPACK_IMPORTED_MODULE_0__.wallet.withdraw(outputAmount);
    }
